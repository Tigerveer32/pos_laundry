                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama_lengkap" id="nama" class="form-control"
                                        value="{{ $admin == null ? old('nama_lengkap') : $admin->nama_lengkap }}">
                                    @error('nama_lengkap')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control"
                                        value="{{ $admin == null ? old('email') : $admin->email }}">
                                    @error('email')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                                        ...
                                        <option value="L" {{ $admin->jenis_kelamin == 'L' ? 'selected' : ''
                                            }}>Laki - Laki</option>
                                        <option value="P" {{ $admin->jenis_kelamin == 'P' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                    @error('jenis_kelamin')
                                    <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="no_handphone" id="no_p" class="form-control"
                                        value="{{ $admin == null ? old('no_handphone') : $admin->no_handphone }}">
                                    @error('no_handphone')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="tempat_lahir" class="form-control" id="tl"
                                                        value="{{ $admin == null ? old('tempat_lahir') : $admin->tempat_lahir }}">
                                                    @error('tempat_lahir')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" name="tanggal_lahir" class="form-control"
                                                        id="tgl"
                                                        value="{{ $admin == null ? old('tanggal_lahir') : $admin->tanggal_lahir }}">
                                                    @error('tanggal_lahir')
                                                    <small class="text-danger"></small>{{ $message }}
                                                    @enderror
                                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="alamat" id="al" cols="30" rows="5"
                                        class="form-control">{{ $admin == null ? old('alamat') : $admin->alamat }}</textarea>
                                    @error('alamat')
                                    <small class="text-danger"></small>{{ $message }}
                                    @enderror
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <br>
                                    <img src="{{ Storage::url($admin->profile) }}" class="img-fluid mb-2 rounded" alt=""
                                        width="40%">
                                    @endif
